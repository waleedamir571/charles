            ...
            <div class="row">
                <div class="col-md-6">
                    <div data-aos="fade-up">
                        ...
                        <p>We carry clearness to intricacy, separating basic subtleties from confounded data to make
                            modern, direct arrangements.We carry clearness to intricacy, separating basic</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <h4>BLOGS</h4>
                    <h2 class="mt-0 about-heading">Ensuring Long-Term Success</h2>
                    <!-- <figure>
                ...
                <div class="col-lg-6 pb-20">
                    <div data-aos="fade-up">
                        ...
                        <p class="text">Explore how innovative logistics solutions can streamline operations, overcome
                            challenges, and drive efficiency for large-scale enterprises, ensuring seamless supply
                            chains and long-term success.</p>
                        <br>
                        <p class="text">
                        ...
                        <ul>
                            <li class="text pb-10"><img class="pr-10" src="assets/images/index/arrow.png" alt="">
                                Eliminate Paperwork Hassles</li>
                            <li class="text pb-10"><img class="pr-10" src="assets/images/index/arrow.png" alt="">
                                Streamlined Connections</li>
                            <li class="text pb-10"><img class="pr-10" src="assets/images/index/arrow.png" alt="">
                                Compliance Made Easy</li>
